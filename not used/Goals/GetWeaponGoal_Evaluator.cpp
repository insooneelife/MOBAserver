...
//-----------------------------------------------------------------------------
double GetWeaponGoal_Evaluator::CalculateDesirability(AbstRaven_Bot* pBot)
{
...
//------------------------------ SetGoal --------------------------------------
void GetWeaponGoal_Evaluator::SetGoal(AbstRaven_Bot* pBot)
{
...
//-------------------------- RenderInfo ---------------------------------------
//-----------------------------------------------------------------------------
void GetWeaponGoal_Evaluator::RenderInfo(Vector2D Position, AbstRaven_Bot* pBot)
{
  std::string s;
