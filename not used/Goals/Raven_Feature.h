...
public:
  ...
  static double Health(AbstRaven_Bot* pBot);
  ...
  static double DistanceToItem(AbstRaven_Bot* pBot, int ItemType);
  ...
  static double IndividualWeaponStrength(AbstRaven_Bot* pBot, int WeaponType);
  ...
  static double TotalWeaponStrength(AbstRaven_Bot* pBot);
};
