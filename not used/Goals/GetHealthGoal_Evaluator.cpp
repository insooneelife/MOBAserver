...
//-----------------------------------------------------------------------------
double GetHealthGoal_Evaluator::CalculateDesirability(AbstRaven_Bot* pBot)
{
...
//----------------------------- SetGoal ---------------------------------------
//-----------------------------------------------------------------------------
void GetHealthGoal_Evaluator::SetGoal(AbstRaven_Bot* pBot)
{
...
//-------------------------- RenderInfo ---------------------------------------
//-----------------------------------------------------------------------------
void GetHealthGoal_Evaluator::RenderInfo(Vector2D Position, AbstRaven_Bot* pBot)
{
