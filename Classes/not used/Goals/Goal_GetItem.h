...
class Goal_GetItem : public Goal_Composite<AbstRaven_Bot>
{
protected:

  int                     m_iItemToGet;

  Trigger<AbstRaven_Bot>*     m_pGiverTrigger;
...
public:
  ...
  Goal_GetItem(AbstRaven_Bot* pBot,
               int        item):Goal_Composite<AbstRaven_Bot>(pBot,
